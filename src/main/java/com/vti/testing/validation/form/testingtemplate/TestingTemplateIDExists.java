...
@Retention(RUNTIME)
@Documented
@Constraint(validatedBy = { TestingTemplateIDExistsValidator.class })
public @interface TestingTemplateIDExists {

	String message() default "{TestingTemplateForm.id.Exists}";
