...
@Retention(RUNTIME)
@Documented
@Constraint(validatedBy = { ExamNameExistsValidator.class })
public @interface ExamNameExists {

	String message() default "The Exam Name does not exist yet";
