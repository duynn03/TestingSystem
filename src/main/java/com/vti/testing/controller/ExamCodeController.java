...
public class ExamCodeController {
	...
	/**
	 * This method is got all examcode.
	 * 
	 * @Description: .
	 * @author: NNDuy
	...
	/**
	 * This method is got examcode by ID.
	 * 
	 * @Description: .
	 * @author: NNDuy
	 * @create_date: Dec 7, 2019
	 ...
	 */
	@GetMapping(value = "/{id}")
	public ResponseEntity<?> getExamCodeByID(@PathVariable(name = "id") short id) {
	 ...
	 */
	@PostMapping()
	public ResponseEntity<?> createExamCode() {
	 ...
	 */
	@PutMapping(value = "/{id}")
	public ResponseEntity<?> updateExamCode() {
	...
	public ResponseEntity<?> deleteExamcode() {
